...
var _user$project$Main$editPlayerClass = F2(
	function (editPlayerId, player) {
		var _p0 = editPlayerId;
		if (_p0.ctor === 'Just') {
...
var _user$project$Main$editInputClass = function (editPlayerId) {
							...
							_1: {
								...
								_1: {
									...
									_0: _elm_lang$html$Html_Attributes$class(
										_user$project$Main$editInputClass(model.playerId)),
									_1: {ctor: '[]'}
								}
							}
						}
				...
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$div,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class(
								A2(_user$project$Main$editPlayerClass, editPlayerId, player)),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
